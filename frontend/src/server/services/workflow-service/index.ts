...
const SEEDS: readonly Seed[] = [
  ...
  { slug: 'noshow-detection',      name: 'No-Show-Erkennung',              category: 'client-lifecycle', description: 'Erkennt versäumte Termine via Kalender-Sync.',              triggerType: 'schedule', nodeCount: 11, active: true,  successRate: 0.93, avgDurationMs: 2800,  hoursSinceLastRun: 4 },
  { slug: 'noshow-response',       name: 'No-Show-Reaktion',               category: 'client-lifecycle', description: 'Automatische Reaktion bei erkanntem No-Show.',              triggerType: 'sub-workflow', nodeCount: 8, active: true, successRate: 0.95, avgDurationMs: 1300, hoursSinceLastRun: 16 },
  ...
  { slug: 'bericht-datensammlung', name: 'Bericht — Datensammlung',        category: 'review-reporting',  description: 'Aggregiert KPIs aus CRM, Billing und Zeiterfassung.',       triggerType: 'schedule', nodeCount: 22, active: true,  successRate: 0.94, avgDurationMs: 14200, hoursSinceLastRun: 24 },
  ...
  { slug: 'follow-up-error-handler',name: 'Follow-up — Error Handler',     category: 'triage-error-handling', description: 'Auffangen fehlgeschlagener Follow-up-Schritte.',            triggerType: 'error',    nodeCount: 6,  active: true,  successRate: 1.00, avgDurationMs: 400,   hoursSinceLastRun: 48 },
];
